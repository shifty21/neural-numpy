...
from mult_8x8 import mult_8x8_approx
...
# PP is for storing the result of this addition
		...
		for i in range(7, -1, -1):
			PP[i+8] = (int(product_LL_binary_msb[i]) + int(product_LH_binary_lsb[i]) + int(product_HL_binary_lsb[i])) % 2
...
def main():
	...
	parser = ArgumentParser(description='Implements 16x16 multiplier. 1st argument is multiplier and 2nd ardgument is multiplicand.')
