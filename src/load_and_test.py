...
# def calculate_sigmoid_table_multip():
#     log = Logger.get_logger(__name__)
#     start = int(round(time.time() * 1000))
...
#     log.info("length of dic generated by multiprocessing %s", (len(dict)))
#     log.info("Total time for sigmoid array %f", time.time() * 1000 - start)

#     return dict

# def print_sigmoid_table(arr, arr1):
#     log = Logger.get_logger(__name__)
#     for i in arr:
#         log.info("key %d value in arr %f value in multiprocessing arr %f", i,
#                  arr[i], arr1[i])
...
if __name__ == "__main__":
    ...
    # sigmoid_arr = calculate_sigmoid_table_multip()
    # print_sigmoid_table(sigmoid_arr, sigmoid_arr1)
