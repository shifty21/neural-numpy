...
def fcl(trn_set, tst_set):
    ...
    model.add(Dense(1024, activation="sigmoid", kernel_initializer="zero", input_dim=28*28))
...
if __name__== "__main__":
    ...
    model.fit(trn_x, trn_y, epochs=1, batch_size=10)
    score = model.evaluate(tst_x, tst_y)
